...
const offers = [
  { id: "regulate", num: "01", title: "Breathwork", subtitle: "Move beyond the mind and into the wisdom of the body.", text: "Kait’s 90-minute breathwork journeys are intentionally paced and deeply held. Guided conscious breathing may be woven with grounding, sound, visualization, gentle movement, rest, and integration.", tags: ["Private", "Small groups", "90 minutes"] },
  { id: "reconnect", num: "02", title: "Reiki + Quantum Energy", subtitle: "A quiet recalibration for the parts of you words cannot reach.", text: "Subtle-energy sessions create a restorative space to slow down, receive, and reconnect. Kait works intuitively, honoring your boundaries, your inner authority, and the pace your system is ready for.", tags: ["1:1", "Energetic support", "Intuitive"] },
  ...
  { id: "movement", num: "04", title: "Yoga + Mindful Movement", subtitle: "Movement as listening, not performance.", text: "Kait’s classes weave mindful movement, breath, philosophy, and spiritual awareness. The practice centers presence, nervous system balance, and an honest relationship with the body you are in today.", tags: ["Weekly classes", "Private", "Retreats"] },
  ...
  { id: "facilitation", num: "06", title: "Private Groups + Facilitation", subtitle: "Gatherings that become more than a moment on the calendar.", text: "Kait curates breathwork, sound, movement, ceremony, and connection for private groups, workshops, retreats, and community experiences. Each format is shaped around the people, purpose, and energy in the room.", tags: ["Custom", "Groups", "Retreats"] },
];

export const metadata = { title: "Offers", description: "Explore breathwork, Reiki, quantum energy work, sound healing, yoga, mentorship, and facilitation with Kait." };

export default function OffersPage() {
  return (
    <PageShell><main>
      <InnerHero eyebrow="Ways to work together" title="Meet yourself where you are." text="Every offering is a doorway. The modality matters, but the way you are held matters more: with consent, compassion, presence, and respect for your own timing." image="/images/kait-sound-healing-opt.jpg" imageAlt="Kait offering sound healing by the ocean" />
      ...
      <section className="split-cta section-pad dark-section">
        ...
        <div><p>Share what you are moving through and what you are longing to feel. Together, you and Kait can choose the experience that meets you there.</p><ArrowLink href="/contact" light>Connect with Kait</ArrowLink></div>
      </section>
      <section className="wide-image"><Image src="/images/kait-costa-rica-opt.jpg" alt="Kait in a lush tropical landscape" fill sizes="100vw" className="cover-image" /></section>
    </main></PageShell>
  );
}
